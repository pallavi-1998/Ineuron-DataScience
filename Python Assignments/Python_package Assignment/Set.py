...
class Custom_set:
    def __init__(self,s):
        ...
        try:
            if type(s) == set:
                self.s=s
                lg.info(f"Set object created with value: {s}")
            else:
                lg.error("Raising exception since set is not passed")
    ...
    def add_set(self,x):
        ...
        try:
            ...
            l.append(x)
            self.s=set(l)
            lg.info(f"Element {x} is added to the Set")
        except Exception as e:
            print(e)
            lg.exception(str(e))
    ...
    def copy_set(self):
        ...
        """
        try:
            lg.info("Returned a shallow copy of a set..")
            l = list(self.s)
            return set(l)
        except Exception as e:
            print(e)
        ...
        try:
            if type(set2) == set:
                ...
                for i in self.s:
                    if i not in set2:
                        s1.add(i)
                lg.info(f"Difference of sets {self.s} and {set2}: {s1}")
                return s1
            else:
                lg.error("Raising exception since set is not passed")
    ...
    def difference_update_set(self, set2):
        ...
        try:
            if type(set2) == set:
                ...
                lg.info("Difference updates of sets is assigned to original set")
            else:
                lg.error("Raising exception since set is not passed")
                raise Exception(f"You have not entered a set: {set2}")
        except Exception as e:
    ...
    def discard_set(self,x):
        ...
        try:
            if x in self.s:
                ...
                lg.info(f"Discard element {x} from the sets")
        except Exception as e:
            print(e)
            lg.exception(str(e))
        ...
        try:
            if type(set2) == set:
                ...
                for i in self.s:
                    if i in set2:
                        s1.add(i)
                lg.info(f"Intersection of sets {self.s} and {set2}: {s1}")
                return s1
            else:
                lg.error("Raising exception since set is not passed")
                raise Exception(f"You have not entered a set: {set2}")
    ...
    def intersection_update_set(self, set2):
        ...
        try:
            if type(set2) == set:
                ...
                lg.info("Intersection updates of sets is assigned to original set")
            else:
                lg.error("Raising exception since set is not passed")
                raise Exception(f"You have not entered a set: {set2}")
        except Exception as e:
    ...
    def isdisjoint_set(self, set2):
        ...
        try:
            if type(set2) == set:
                ...
                lg.info(f"Checking if {self.s} and {set2} are disjoint or not")
    ...
    def issubset_set(self, set2):
        ...
        """
        try:
            lg.info(f"Checking if {self.s} is a subset of {set2} or not")
            if type(set2) == set:
                flag = 0
                for i in self.s:
                    if i not in set2:
    ...
    def issuperset_set(self, set2):
        ...
        """
        try:
            lg.info(f"Checking if {self.s} is a superset of {set2} or not")
            if type(set2) == set:
                flag = 0
                for i in set2:
                    if i not in self.s:
    ...
    def pop_set(self):
        ...
        try:
            if self.s:
                ...
                x = l.pop(r)
                self.s = set(l)
                lg.info(f"Poping set element {x} from set")
                return x
            else:
                lg.error("Raising exception since set is empty")
    ...
    def remove_set(self, x):
        ...
        try:
            if x in self.s:
                ...
                l.remove(x)
                self.s = set(l)
                lg.info(f"Removed set element {x} from set")
            else:
                lg.error("Raising exception since set is empty")
    ...
    def symmetric_difference_set(self,set2):
        ...
        """
        try:
            lg.info(f"Creating symmetric_difference of sets: {self.s} and {set2}")
            if type(set2) == set:
                return self.s ^ set2
            else:
                lg.error("Raising exception since set is not passed")
    ...
    def symmetric_difference_update_set(self,set2):
        ...
        """
        try:
            lg.info("Creating symmetric_difference_update of 2 sets")
            if type(set2) == set:
                self.s = self.s ^ set2
            else:
                lg.error("Raising exception since set is not passed")
        ...
        try:
            ...
            for x in args:
                if type(x) != set:
                    ...
                    return
                u = u | x
            lg.info(f"Creating union of sets: {u}")
            return u
        except Exception as e:
            print(e)
            lg.exception(str(e))
    ...
    def update_set(self,*args):
        ...
        """
        try:
            lg.info(f"Creating update of  sets..")
